...
def create_upvote(
    ...
    if not incident.get('ward', None) or citizen_db_data and citizen_db_data.get('_id', None) \
            and incident['ward'] in citizen_db_data.get('wards', None):
